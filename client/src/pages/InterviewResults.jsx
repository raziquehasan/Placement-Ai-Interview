        ...
        <div className="min-h-screen bg-gray-50 py-10">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex flex-col sm:flex-row gap-5 mb-20">
                    ...
                    {interview?.status === 'round1_completed' && (
                        <button
                    ...
                    {interview?.status === 'round2_completed' && (
                        <button
                            onClick={() => alert('Coding Round Implementation is in Phase 2.3!')}
                    ...
                    <button
                        onClick={() => alert('PDF report is being generated by the AI Engine...')}
